...
status: draft
definition: >-
  The basic physical and functional unit of heredity, composed of a specific sequence of nucleotides along a DNA
  molecule that codes for a specific functional polypeptide (protein) or RNA product.
symbol: null
unit: null
equation: null
examples:
...
learning_objectives:
  - Define a gene as a functional segment of DNA.
  - Explain how genes determine physical traits (phenotype) through protein expression.
  - Distinguish between dominant and recessive alleles of a gene.
real_world_applications:
  - Gene editing technologies (CRISPR-Cas9) and gene therapy.
  - Agricultural crop breeding for drought and disease resistance.
provenance:
  ai_drafted: true
...
Genes express inherited traits by guiding cellular protein synthesis.
