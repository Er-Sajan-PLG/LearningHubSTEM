...
status: draft
definition: >-
  A double-stranded helical nucleic acid molecule storing genetic instructions used in the development,
  functioning, growth, and reproduction of all known living organisms and many viruses.
symbol: DNA
unit: null
equation: null
examples:
...
learning_objectives:
  - Describe the double-helix structure of DNA composed of nucleotide units (sugar, phosphate, nitrogenous bases A, T, C, G).
  - Explain complementary base pairing rules (A with T, C with G).
  - Describe the role of DNA in genetic inheritance and protein synthesis.
real_world_applications:
  - Forensic DNA profiling and paternity testing.
  - Genetic testing for hereditary medical conditions.
provenance:
  ai_drafted: true
...
DNA base sequences encode instructions for assembling cellular proteins.
