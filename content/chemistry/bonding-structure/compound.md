---
id: lhs:chem.compound
type: concept
name: Chemical Compound
domain: chemistry
status: draft
definition: >-
  A pure substance formed when two or more different chemical elements are chemically bonded together in
  a fixed stoichiometric ratio. Compounds have chemical properties distinct from their constituent elements.
symbol: null
unit: null
equation: null
examples:
...
learning_objectives:
  - Define a chemical compound and distinguish it from a mixture.
  - Interpret chemical formulae representing molecular and ionic compounds.
  - Explain how chemical bonding creates compounds with unique properties.
real_world_applications:
  - Pharmaceuticals and drug formulation.
  - Water treatment and agricultural fertilizers.
provenance:
  ai_drafted: true
...
Compounds can be molecular (covalent) or lattice-based (ionic/metallic).
