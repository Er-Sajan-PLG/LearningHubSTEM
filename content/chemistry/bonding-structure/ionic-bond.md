...
status: draft
definition: >-
  A chemical bond formed through the electrostatic attraction between oppositely charged ions, resulting
  from the complete transfer of one or more valence electrons from a metal atom to a non-metal atom.
symbol: null
unit: null
equation: null
examples:
...
learning_objectives:
  - Describe electron transfer leading to cation and anion formation.
  - Explain how electrostatic forces hold ionic crystal lattices together.
  - Predict formula units for binary ionic compounds (e.g. NaCl, MgO).
real_world_applications:
  - Table salt production and mineralogy.
  - Electrolyte solutions in batteries and physiological fluids.
provenance:
  ai_drafted: true
...
Ionic compounds typically exhibit high melting points and conduct electricity when molten or dissolved.
