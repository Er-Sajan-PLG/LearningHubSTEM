...
status: draft
definition: >-
  A chemical reaction between an acid and a base (or alkali) producing a salt and water, in which hydrogen ions (H⁺)
  from the acid react with hydroxide ions (OH⁻) from the base to form neutral water molecules (H₂O).
symbol: null
unit: null
...
learning_objectives:
  - Write word and balanced chemical equations for acid-base neutralization.
  - Predict the specific salt formed from given acids and bases (e.g. HCl + NaOH → NaCl + H₂O).
  - Explain how neutralization changes solution pH toward neutral.
real_world_applications:
  - Agricultural liming to neutralize acidic soil.
  - Treatment of industrial acidic wastewater prior to discharge.
provenance:
  ai_drafted: true
...
Neutralization is exothermic and essential for physiological buffer systems.
