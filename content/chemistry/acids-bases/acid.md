...
status: draft
definition: >-
  A chemical substance that releases hydrogen ions (H⁺ or hydronium H₃O⁺) in aqueous solution, tastes sour,
  turns blue litmus paper red, has a pH less than 7, and reacts with bases to form salts and water.
symbol: null
unit: null
equation: null
examples:
...
learning_objectives:
  - Define an acid according to Arrhenius (H⁺ producer) and Brønsted-Lowry (proton donor) models.
  - Distinguish strong acids (fully ionized) from weak acids (partially ionized).
  - Describe characteristic acid reactions with metals, carbonates, and bases.
real_world_applications:
  - Stomach digestion (hydrochloric acid).
  - Lead-acid car batteries (sulfuric acid) and food preservation (vinegar/acetic acid).
provenance:
  ai_drafted: true
...
Acids act as proton donors in aqueous chemical solutions.
