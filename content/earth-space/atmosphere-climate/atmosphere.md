...
status: draft
definition: >-
  The layer of gases surrounding Earth, retained by Earth's gravity, composed primarily of nitrogen (78%) and
  oxygen (21%), which absorbs ultraviolet radiation, warms the surface via the greenhouse effect, and regulates weather.
symbol: null
unit: null
equation: null
examples:
...
learning_objectives:
  - Describe the gas composition and vertical structure of the atmosphere (troposphere, stratosphere, mesosphere, thermosphere).
  - Explain how atmospheric pressure decreases with altitude.
  - Analyze the natural greenhouse effect and thermal radiation absorption.
real_world_applications:
  - Aviation and satellite orbit decay management.
  - Climate change mitigation and air quality control.
provenance:
  ai_drafted: true
...
The atmosphere protects life from solar radiation and regulates surface temperature extremes.
