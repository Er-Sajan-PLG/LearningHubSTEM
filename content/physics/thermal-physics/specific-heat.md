...
status: draft
definition: >-
  The amount of heat energy required to raise the temperature of 1 kilogram of a substance by
  1 kelvin (or 1 degree Celsius). Different substances have different specific heat capacities.
symbol: c
...
common_misconceptions:
  ...
  - Specific heat depends on mass (it is a property of the substance, independent of mass).
learning_objectives:
