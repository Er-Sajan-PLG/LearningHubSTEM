...
status: draft
definition: >-
  The number of complete wave cycles passing a given point per unit time. Frequency determines
  the pitch of sound and the color of light.
symbol: f or ν (nu)
unit: hertz (Hz)
...
learning_objectives:
  - Define frequency and its unit (hertz).
