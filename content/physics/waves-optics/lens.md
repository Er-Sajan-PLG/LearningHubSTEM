...
status: draft
definition: >-
  A transparent optical device that refracts light to converge or diverge rays. Convex (converging)
  lenses bring light to a focus; concave (diverging) lenses spread light apart.
symbol: null
unit: null
...
common_misconceptions:
  ...
  - Thicker lenses always have shorter focal length (depends on curvature and refractive index).
learning_objectives:
