...
status: draft
definition: >-
  Motion under the influence of gravitational force alone, with no other forces (especially air
  resistance) acting. In free fall, all objects experience the same acceleration regardless of mass,
...
common_misconceptions:
  ...
  - Gravity is stronger on heavier objects (gravitational acceleration is independent of mass).
learning_objectives:
