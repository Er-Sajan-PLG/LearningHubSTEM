...
`docs/GOVERNANCE.md` and `docs/LEARNINGHUBSTEM-SPECIFICATION.md`.

| Term | Meaning |
|------|---------|
| **LearningHubSTEM** | The open, structured, reusable STEM knowledge foundation; independent of any product. |
| **canonical knowledge** | The source-of-truth STEM knowledge in `LearningHubSTEM/content/` (Markdown + YAML frontmatter), version-controlled. |
...
| **consumer** | Anything that builds on LearningHubSTEM: a curriculum, a product, a research tool, an AI system. |
...
| **ecosystem invariant** | A Level-1 rule that project governance may not redefine (LearningHubSTEM independence, curriculum external, products as consumers…). |
