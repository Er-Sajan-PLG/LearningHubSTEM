...
|---|--------|---------|--------|
| 0001 | [license.md](0001-license.md) | Knowledge + code licensing (CC BY 4.0 content / MIT code) | decided (2026-09-03) |
...
| 0025 | [0025-claim-integrity-and-release-discipline.md](0025-claim-integrity-and-release-discipline.md) | Claim signatures + duplicate gate, edit-in-place detection, connection-triple immutability, release manifest + migrations log (plan v2 E0.2/E0.3/E1.6/E4.3–E4.5/E5.3/E5.5) | decided (implemented) |
